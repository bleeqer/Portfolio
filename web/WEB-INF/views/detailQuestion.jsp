...
<%--                            </div>--%>
                    ...
                    <div id="answer-list">
                        ...
                        <c:forEach var="answer" items="${answers}" varStatus="loop">
                            ...
                            <%--Answer--%>
                            <div class="answer pt-2 border-bottom-gray mt-1" data-ans-no="${answer.ansNo}" data-ques-no="${answer.quesNo}" <c:if test="${loop.index >= 3}"> style="display: none;"</c:if>>
                                <div>
                                            ...
                                            <div>
                                                ...
                                                <div class="mb-2 d-flex">
                                                    ...
                                                    <div class="me-3 position-relative">
                                                        <div>
                                                            <img class="answer-user-photo rounded-circle border border-color-whiten" src="/uploadedImages${answer.userPhoto}" alt="" width="36" height="36">
                                                        </div>
                                                        ...
                                                        <div class="d-flex justify-content-center align-items-center my-1"
                                                            ...
                                                            <div class="ms-auto d-flex">
                                                                ...
                                                                <sec:authorize access="isAuthenticated()">
                                                                    <c:if test="${principal == answer.userEmail}">
                                                                <div>

                    ...
                    <div>
                        ...
                        <div class="border-bottom-gray">
                            <div class="d-flex color-dark-gray">
                                ...
                                <div class="py-3 px-2 color-dark-gray bg-hover-whiten-light position-relative" style="font-size: 13px;">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="mb-2 d-flex">
                                                            ...
                                                            <div class="me-1 position-relative d-flex justify-content-center align-items-center">
                                                                <div>
                                                                    <img class="rounded-circle border border-color-whiten" src="${answerPair.answerUserPhoto}" alt="" width="36" height="36">
                                                                </div>
                                                            ...
                                                            <div class="d-flex flex-column">
                                                                    ...
                                                                    <%--이름--%>
                                                                <div class="my-auto"><a class="text-decoration-none link-default-color hover-underline h6" href="" style="font-size: 13px;"><strong>${answerPair.answerUserName}</strong></a></div>

                                                                    <%--상세--%>
                                                                <div class="my-auto color-gray" style="font-size: 13px;">${answerPair.answerUserOccupation}<span> · </span>${answerPair.answerRegDate}</div>
                                                        ...
                                                        <div>
                                                            <div>
                                                                <a class="text-decoration-none link-default-color hover-underline" href="#" style="font-size: 16px;"><b>${answerPair.question}</b></a>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div>
                                                                ...
                                                                <div>
                                                                    <div class="d-flex justify-content-between position-relative">
                                                                            <%--Question title--%>
                                                                        <div class="pe-2">
                                                                            <a class="hover-underline" href="/question/${question.quesNo}"><b>${question.question}</b></a>
                                                                        </div>
                                                                            <%--Question close--%>

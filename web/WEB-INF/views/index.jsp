                                        ...
                                        <div class="comment-section"
                                            ...
                                            <div class="bg-dark">
                                                <div>
                                                        ...
                                                        <%--Each comment--%>
                                                    <div class="comment-list px-3 pt-2" data-ans-no="${answerPair.ansNo}">

                                                            <%--Comment--%>
<%--                                                        <div class="comment pb-1" data-co-no="">--%>

<%--                                                                &lt;%&ndash;Comment node&ndash;%&gt;--%>
<%--                                                            <div class="d-flex flex-column">--%>

<%--                                                                    &lt;%&ndash;Comment&ndash;%&gt; &lt;%&ndash;레벨이 0인 댓글은 프로필 사진 크기 조절&ndash;%&gt;--%>
<%--                                                                <div class="d-flex">--%>

<%--                                                                        &lt;%&ndash;Profile pic&ndash;%&gt;--%>
<%--                                                                    <div>--%>
<%--                                                                        <div>--%>
...
<%--                                                                    &lt;%&ndash;Comment&ndash;%&gt; &lt;%&ndash;레벨이 0보다 큰 댓글은 class에 hidden, 레벨xpadding&ndash;%&gt;--%>

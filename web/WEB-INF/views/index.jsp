                                                                    ...
                                                                    <div>
                                                                        <div class="d-flex justify-content-between">
                                                                            ...
                                                                            <div class="position-absolute" style="top: 4px; right: 4px;">
                                                                                <div>
                                                                                    <span class="hide-button bg-hover-whiten-light rounded-circle d-inline-block d-flex align-items-center justify-content-center" style="width: 38px; height: 38px;" data-ques-no="${answerPair.quesNo}" data-toggle="description" data-content="Hide">
